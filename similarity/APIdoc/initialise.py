...
import chromadb
import similarity.APIdoc.file_control as file_control

COLLECTION_NAME = "pdf_collection"
HOST = "localhost"
PORT = 8000

chroma_server_client = chromadb.HttpClient(host="localhost", port="8000")
...
def create_pdf_collection(collection_name: str = COLLECTION_NAME):
    ...
    if chunked_documents:
        ...
        file_control.update_list(file_control.get_folder_pdf())
    else:
